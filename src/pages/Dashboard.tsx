    ...
    <MainLayout>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        <SummaryCard
          ...
          description={`${
            todayJobs.filter((j) => j.paymentStatus === "paid").length
          } completed, ${
            todayJobs.filter((j) => j.paymentStatus !== "paid").length
          } pending`}
        />
            ...
            {recentJobs.map((job) => (
              ...
              >
                ...
                <div className="text-right">
                  ...
                  >
                    {job.paymentStatus.charAt(0).toUpperCase() +
                      job.paymentStatus.slice(1)}
                  </span>
                </div>
              </div>
            ))}
            ...
            {recentPayments.map((payment) => (
              ...
              >
                <div>
                  ...
                  <p className="text-xs text-muted-foreground">
                    {payment.method.toUpperCase()} • {payment.date}
                  </p>
                </div>
                <p
                  className={cn("font-semibold text-sm font-mono", {
